        ...
        <main>
            ...
            <article className = 'JournalEntry'>
                ...
                <div className="JournalMainContent">
                   ...
                   {props.entry.country && <span className = 'JournalCountry'>{props.entry.country}</span>}
                    {props.entry.googleMapsLink && <a className = 'JournalLink' href={props.entry.googleMapsLink} >View on Google Maps</a>}
                   {props.entry.title && <h2 className="JournalPlace">{props.entry.title}</h2>}
                    {props.entry.dates && <h6 className = 'JournalTripDates'>{props.entry.dates}</h6>}
                    {props.entry.text && <p className = 'JournalDesc'>{props.entry.text}</p>}
