        ...
        <main>
            <article className = 'JournalEntry'>
                ...
                <div className="JournalMainContent">
                    ...
                    {props.place && <span className = 'JournalCountry'>{props.place}</span>}
                    {props.googleMapsLink && <a className = 'JournalLink' href={props.googleMapsLink} >View on Google Maps</a>}
                   {props.place && <h2 className="JournalPlace">{props.place}</h2>}
                    {props.tripDates && <h6 className = 'JournalTripDates'>{props.tripDates}</h6>}
                    {props.description && <p className = 'JournalDesc'>{props.description}</p>}
